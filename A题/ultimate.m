...
% 虚线句柄
smoke_traj_handle = plot3(smoke_traj(:,1), smoke_traj(:,2), smoke_traj(:,3), '--', 'Color', [0.5 0.5 0.5], 'LineWidth', 1.5);
missile2target_handle = plot3([M1_positions(1,1), true_target_center(1)], ...
                              [M1_positions(1,2), true_target_center(2)], ...
                              [M1_positions(1,3), true_target_center(3)], ...
                              '--r', 'LineWidth', 1.5);
...
% GIF文件
gif_filename = 'missile_smoke_animation.gif';
...
for i = 1:n_frames
    ...
    if smoke_exists(i) && smoke_visible(i)
        set(smoke_handle, 'XData', Xs + smoke_positions(i,1), ...
                          ...
                          'ZData', Zs + smoke_positions(i,3), 'Visible','on');
    else
        set(smoke_handle, 'Visible','off');
    end
